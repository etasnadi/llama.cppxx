...
#undef CREATE_GLU
    ...
    for (uint32_t s = 0; s < CONV_SHAPE_COUNT; ++s) {
        ...
        std::vector<uint32_t> spec_constants = { conv2d_WG_SIZE, conv2d_BS_K, conv2d_BS_CRS, conv2d_BS_NPQ, conv2d_TS_K, use_collectives, conv2d_SHMEM_PAD, device->subgroup_size};
